<?php 
	...
	$db = mysql_connect("localhost", "frogosteve", "ogorf82");
	mysql_select_db("TwitterDataStore", $db);
		
	$sql = "SELECT id, twittergeo, google_location FROM `$table` Order by id";
	$res = mysql_query($sql, $db);
